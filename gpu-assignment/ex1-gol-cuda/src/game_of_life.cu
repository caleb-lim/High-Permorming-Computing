...
// void compare(int *cpu, int *gpu){

//     int passed = 1;
//     int n = sizeof(cpu) / sizeof(cpu[0]);
...
=======
    // compare(final_state, final_state_cuda);
>>>>>>> d1e922f01f47833ce96c23e4e84d0221d65ce571
